...
lines(autos_data$cowboy,   type="o", pch=22, lty=2, col=plot_colors[2])
lines(autos_data$warp,     type="o", pch=23, lty=3, col=plot_colors[3])
lines(autos_data$ocsigen,  type="o", pch=24, lty=4, col=plot_colors[4])
lines(autos_data$nodejs,   type="o", pch=25, lty=5, col=plot_colors[5])
lines(autos_data$vibe,     type="o", pch=21, lty=6, col=plot_colors[6])
lines(autos_data$gohttp,   type="o", pch=22, lty=7, col=plot_colors[7])
lines(autos_data$httpkit,  type="o", pch=23, lty=8, col=plot_colors[8])

legend("topleft", c("ngnix","cowboy","warp","ocsigen","nodejs","vibe","gohttp","http-kit"), cex=1, col=plot_colors, pch=21:25, lty=1:8);
